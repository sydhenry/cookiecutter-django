...
Testing the useability of cookiecutter-djagno
...
DJANGO_DEFAULT_FROM_EMAIL               DEFAULT_FROM_EMAIL          n/a                                            "cookiecutter-django <noreply@cookiecutter-djagno.herokuapps.com>"
DJANGO_SERVER_EMAIL                     SERVER_EMAIL                n/a                                            "cookiecutter-django <noreply@cookiecutter-djagno.herokuapps.com>"
DJANGO_EMAIL_SUBJECT_PREFIX             EMAIL_SUBJECT_PREFIX        n/a                                            "[cookiecutter-django] "
DJANGO_ALLOWED_HOSTS                    ALLOWED_HOSTS               ['*']                                          ['cookiecutter-djagno.herokuapps.com']
======================================= =========================== ============================================== ======================================================================
...
.. code-block:: bash
    ...
    celery -A cookiecutter-django.taskapp worker -l info
...
To run the tests, enter the cookiecutter-django/tests directory and run the following commands::
...
application stacks on one host, remove the port setting entirely and add `VIRTUAL_HOST=cookiecutter-djagno.herokuapps.com` to your env file.
This pass all incoming requests on `nginx-proxy` to the nginx service your application is using.

.. _nginx-proxy: https://github.com/jwilder/nginx-proxy

Postgres is saving its database files to `/data/cookiecutter-django/postgres` by default. Change that if you wan't
...
If you are using `supervisor`, you can use this file as a starting point::
    ...
    [program:cookiecutter-django]
    command=docker-compose up
    directory=/path/to/cookiecutter-django
...
Place it in `/etc/supervisor/conf.d/cookiecutter-django.conf` and run::

    supervisorctl reread
    supervisorctl start cookiecutter-django
