...
ALLOWED_HOSTS = env.list('DJANGO_ALLOWED_HOSTS', default=['cookiecutter-djagno.herokuapps.com'])
...
EMAIL_SUBJECT_PREFIX = env("DJANGO_EMAIL_SUBJECT_PREFIX", default='[cookiecutter-django] ')
